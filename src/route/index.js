...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrapLes3', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrapLes3', {
    layout: 'bootstrap',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrapLes4', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrapLes4', {
    layout: 'bootstrap',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrapLes5', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrapLes5', {
    layout: 'bootstrap',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrapLes6', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrapLes6', {
    layout: 'bootstrap',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
